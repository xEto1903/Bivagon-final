...
const products = ref([
  {
    id: 1,
    name: 'Buz Kırıcı Makinesi',
    price: 3586.01,
    image: 'https://static.ticimax.cloud/cdn-cgi/image/width=293,quality=85/39045/uploads/urunresimleri/buyuk/buz-kirici-makinemutfakbar-yardimci--m-dd274d.jpg',
    isNew: true,
  ...
  {
    id: 2,
    name: 'Cips Dilimleme Mandolini',
    price: 2551.88,
    image: 'https://static.ticimax.cloud/cdn-cgi/image/width=293,quality=85/39045/uploads/urunresimleri/buyuk/cips-dilimleme-mandolinmutfakbar-yardi-0-fccf.jpg',
    isNew: false,
    hasFreeShipping: true,
    soldOut: true,
  },
  {
    id: 3,
    name: 'Erişte Makinesi Marcato 180',
    price: 7489.77,
    image: 'https://static.ticimax.cloud/cdn-cgi/image/width=293,quality=85/39045/uploads/urunresimleri/buyuk/eriste-makinasi-markato-180-mmmutfakba-8-8ad4.jpg',
    isNew: true,
    hasFreeShipping: true,
    soldOut: true,
  },
